...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validate quantity
    elseif ($quantity <= 0) {
        $errorMessage = "Error: Quantity must be a positive number.";
    }
    // Check for empty required fields
    elseif (empty($phone) || empty($foodType) || empty($pickupOption)) {
    ...
    <div class="donor-info">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="quantity" id="quantity" class="form-control" value="<?php echo isset($_POST['quantity']) ? max(1, intval($_POST['quantity'])) : ''; ?>" min="1" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="message" id="message" class="form-control" rows="4"><?php echo isset($_POST['message']) ? htmlspecialchars($_POST['message']) : ''; ?></textarea>
            </div>
...
<script>
    <?php if ($donationSuccess): ?>
        Swal.fire({
            title: 'Thank You!',
            text: 'Check it out! Your donation has been successfully recorded in User Dashboard',
